...
class LandoInfoView {
    ...
    parseTree() {
        this.text = child_process_1.execSync('lando info --format json', { cwd: this.workspaceFolderPath }).toString();
...
exports.LandoInfoView = LandoInfoView;
//# sourceMappingURL=landoInfoView.js.map