...
function copyToClipboard(text) {
    ...
    // });
    vscode_1.window.showInformationMessage('Clipboard Feature Coming Soon');
}
...
function checkVersion(fullVersion) {
...
function activate(context) {
    ...
    exports.workspaceFolderPath = vscode_1.workspace.workspaceFolders ? vscode_1.workspace.workspaceFolders[0].uri.fsPath : '';
    ...
    // ----------------- Tree Providers -----------------
    let landoInfoProvider = new landoInfoProvider_1.LandoInfoProvider(context, exports.workspaceFolderPath);
    ...
    context.subscriptions.push(...[
        ...
        registerCommand('lando-ui.start', () => lando.start(exports.workspaceFolderPath)),
        registerCommand('lando-ui.stop', () => lando.stop(exports.workspaceFolderPath)),
        registerCommand('lando-ui.restart', () => lando.restart(exports.workspaceFolderPath)),
    ...
    var watcher = vscode_1.workspace.createFileSystemWatcher(exports.workspaceFolderPath + '/*.yml');
...
function info(dir) {
    try {
        ...
        if (e.toString().includes('Could not find app in this dir or a reasonable amount of directories above it') ||
            ...
            vscode_1.window.showWarningMessage('Could not find an app. Please initiate a lando project.');
            return '["No app found"]';
        }
        return '["No app found"]';
    }
...
class LandoInfoProvider {
    constructor(context, workspaceFolderPath) {
